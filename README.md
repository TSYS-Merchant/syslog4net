...
•	Access to structured data, tied to log4net’s contexts
...
Examples
====
Check out the simple Hello World example. [TODO: link to GitHub]
...
You can also always find help on our Google Group. Please send a message to [TODO]

Downloading / Installation
====
Currently, Merchant Warehouse’s log4net extension is only available as a source download. If you’d like to provide a Nuget package
